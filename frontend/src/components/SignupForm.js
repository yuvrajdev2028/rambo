...
const SignupForm = () => {
  return (
      <form action='/' className='flex flex-col'>
        <label for='username' className='text-left text-sm font-semibold'>EMAIL ID</label>
        <input type='text' name='email' id='email' className='bg-[#EFF0F2] p-2' placeholder='Email ID'></input>
        <label for='username' className='text-left text-sm font-semibold mt-2'>USERNAME</label>
